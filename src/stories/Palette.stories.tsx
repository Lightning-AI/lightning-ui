...
export const All = () => {
  return (
    <>
        <Box>
            <Typography variant={"h6"} sx={{marginLeft: 1}}>PRIMARY</Typography>
            <Box display={"flex"}>
                <Box display={"flex"} flexDirection={"column"}>
                    <Box m={1} width={65} height={65} sx={{backgroundColor: 'primary.70'}}></Box>
                    <Typography variant={"body1"} align={"center"}>70</Typography>
                </Box>
                <Box display={"flex"} flexDirection={"column"}>
                ...
                <Box display={"flex"} flexDirection={"column"}>
                    ...
                    <Typography variant={"body1"} align={"center"}>40</Typography>
                </Box>
                <Box display={"flex"} flexDirection={"column"}>
                ...
                <Box display={"flex"} flexDirection={"column"} marginLeft={10}>
                    <Box m={1} width={65} height={65} sx={{background: (theme: any) => theme.palette.primary.gradient}}></Box>
                    <Typography variant={"body1"} align={"center"}>GRADIENT</Typography>
                </Box>
            </Box>
        </Box>
        <Box>
            <Typography variant={"h6"} sx={{marginLeft: 1}}>SECONDARY</Typography>
            <Box display={"flex"}>
                <Box display={"flex"} flexDirection={"column"}>
        ...
        <Box>
            <Typography variant={"h6"} sx={{marginLeft: 1}}>SUCCESS</Typography>
            <Box display={"flex"}>
                <Box display={"flex"} flexDirection={"column"}>
        ...
        <Box>
            <Typography variant={"h6"} sx={{marginLeft: 1}}>WARNING</Typography>
            <Box display={"flex"}>
                <Box display={"flex"} flexDirection={"column"}>
        ...
        <Box>
            <Typography variant={"h6"} sx={{marginLeft: 1}}>ERROR</Typography>
            <Box display={"flex"}>
                <Box display={"flex"} flexDirection={"column"}>
        ...
        <Box>
            <Typography variant={"h6"} sx={{marginLeft: 1}}>GREY</Typography>
            <Box display={"flex"}>
                <Box display={"flex"} flexDirection={"column"}>
                    <Box m={1} width={65} height={65} sx={{backgroundColor: 'grey.100'}}></Box>
                    <Typography variant={"body1"} align={"center"}>100</Typography>
                </Box>
                <Box display={"flex"} flexDirection={"column"}>

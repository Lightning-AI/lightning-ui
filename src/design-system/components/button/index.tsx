...
const Button = (props: ButtonProps) => {
    ...
    const color = (theme: any) => { return ((isGreyColor && theme.palette.common.black) || theme.palette.common.white)};
    const background = (theme: any) => { return (isPrimaryColor && theme.palette.primary.gradient)};
